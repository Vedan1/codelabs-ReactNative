    ...
    <SafeAreaView className='bg-primary h-full'>
      <ScrollView>
        ...
        <View className='w-full justify-center  min-h-[50vh]  px-6 my-6'>
          <Text classname='text-white-100 text-sm'>Signup 2 of 4</Text>
          <Text className='text-4xl mt-2 font-bold mb-10 text-black'>Farm Info</Text>
      ...
      <CustomBottom
        title={'Continue'}
        back={false}
        handlePress={()=>{router.push('/sign-up-verif')}}
        />
        </View>
    </SafeAreaView>
  )
